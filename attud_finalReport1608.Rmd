...
sjp.frq(attud$group5.q3, geom.colors="grey", coord.flip = TRUE, expand.grid = T)
```
...
```{r echo = FALSE, message=FALSE, warning=FALSE}
sjp.xtab(attud$group5.q3, attud$Income, margin = "col", title = "Hours of Instruction", axis.titles="", rev.order=F, show.n=T, show.summary=T, show.total = T, prnt.plot =FALSE, geom.colors = "Greys")$plot


a<-sjp.xtab(attud$group5.q3, attud$Income, margin = "col", title = "Hours of Instruction", axis.titles="", rev.order=F, show.n=T, show.summary=T, show.total = T, prnt.plot =FALSE, geom.colors = "Greys")
```
...
data_access<-sjp.xtab(attud$group5.q5, attud$Income, margin = "col", title = "Access to tabacco treatment", rev.order=F, show.n=T, show.summary=T, axis.titles="", show.total = T, prnt.plot =FALSE)$mydf
write.csv2(data_access, "~/ATTUD/data_access.csv")
```
